 ...
 * @version $Id$
 */
public class URLSourceFactory extends org.apache.excalibur.source.factories.URLSourceFactory
    implements Parameterizable, ThreadSafe
{
    ...
    {
        org.apache.excalibur.source.factories.URLSource result = new URLSource();
        result.setConnectTimeout(this.parameters.getParameterAsInteger(CONNECT_TIMEOUT, -1));
        result.setReadTimeout(this.parameters.getParameterAsInteger(READ_TIMEOUT, -1));
